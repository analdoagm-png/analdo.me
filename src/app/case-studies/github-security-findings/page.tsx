...
/**
 * Third and last showcase case study moved to the new sidebar system,
 * following Forty5Park and Uber Suite exactly — see Forty5Park's own
 * comments for the full rationale (centered `items-center` column, `w-full
 * max-w-[720px]` text / `w-full max-w-[1280px]` images, inline YEAR/intro/
 * section text, no `CaseStudyNext`).
 *

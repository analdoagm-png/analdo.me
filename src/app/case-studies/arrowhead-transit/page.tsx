...
import {
  EditorialSidebar,
  EditorialMobileBar,
} from "@/components/case-study-editorial-sidebar";
...
export default function ArrowheadTransitCaseStudy() {
  return (
    <>
      {/*
        Editorial case studies (GoRight, Arrowhead Transit) use a persistent
        sidebar instead of CaseStudyHeader — see EditorialSidebar for why —
        so this page renders its own skip link, matching the homepage's
        treatment.
      */}
      <a
        href="#main-content"
      ...
      <main id="main-content" className="flex-1">
        <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-8 px-6 py-8 md:gap-12 md:p-12 lg:flex-row lg:items-start lg:gap-12 lg:p-16">
          <EditorialSidebar className="lg:sticky lg:top-16 lg:w-72 lg:shrink-0" />

          <section className="flex w-full flex-col items-start gap-6 md:gap-16 lg:flex-1">

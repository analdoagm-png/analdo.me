  ...
  return (
    <footer className="w-full border-t border-stroke-dark">
      <div className="mx-auto flex w-full max-w-[1280px] items-center justify-between gap-4 px-6 py-6 md:px-10 lg:px-16">
        <p className="text-body-h2 text-white/70">© Analdo Gomez / 2026</p>
        <div className="flex shrink-0 items-center gap-4">
          {contactLinks.map(({ href, icon, label }) => (
            <a
              ...
              href={href}
              target="_blank"
              className="relative inline-flex items-center justify-center gap-2 p-1 text-body-h2 text-white transition-colors duration-200 before:absolute before:-inset-2 before:content-[''] hover:text-white/60 active:text-white/40 md:p-0 md:before:content-none"
            >
